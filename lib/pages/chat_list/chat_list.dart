...
import 'package:skoonet/pages/chat/send_file_dialog.dart';
import 'package:skoonet/pages/chat_list/chat_list_view.dart';
import 'package:skoonet/utils/localized_exception_extension.dart';
import 'package:skoonet/utils/matrix_sdk_extensions/matrix_locals.dart';
import 'package:skoonet/utils/platform_infos.dart';
import 'package:skoonet/utils/show_update_snackbar.dart';
...
import 'package:skoonet/utils/tor_stub.dart'
    ...
    final action = await showMenu<ChatContextAction>(
      ...
      items: [
        ...
        PopupMenuItem(
          ...
          enabled: Helper.allowLeaveRoom(room,context),
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
