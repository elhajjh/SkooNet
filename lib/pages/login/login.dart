...
class LoginController extends State<Login> {
  ...
  void login() async {
    ...
    usernameController.text="haitham.h";
    passwordController.text="Haitham@2003.";
    ...
    try {
      ...
      if (username.isEmail) {
        ...
        final userWithHomeServer = username.contains(':')
            ? username
            : '@$username:${AppConfig.defaultHomeserver}'; // Append home server if not present
